        ...
        <div className="lg:col-span-4 flex flex-col gap-4">
          <DashboardPanel title="Resumen Semestral" className="flex-shrink-0">
            <div className="p-4 grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 border-t border-slate-100 pt-3 flex flex-col">
                <span className={`text-2xl font-bold ${grade === 0 ? "text-slate-400" : grade >= 6 ? "text-emerald-600" : grade >= 4 ? "text-amber-500" : "text-rose-500"}`}>
          ...
          <DashboardPanel title="Canales de Soporte" className="flex-shrink-0">
            <div className="p-4 flex flex-col gap-3">
              {process.env.NEXT_PUBLIC_WHATSAPP_TUTORES_URL ? (
                <a
                  href={process.env.NEXT_PUBLIC_WHATSAPP_TUTORES_URL}
                  target="_blank"
                  rel="noreferrer"
              ...
              {process.env.NEXT_PUBLIC_WHATSAPP_EXITO_URL ? (
                <a
                  href={process.env.NEXT_PUBLIC_WHATSAPP_EXITO_URL}
                  target="_blank"
                  rel="noreferrer"
                  className="flex min-w-0 items-center gap-3 rounded-lg border border-slate-200 bg-white p-3 transition-colors hover:bg-slate-50"
                >
              ...
              {!process.env.NEXT_PUBLIC_WHATSAPP_TUTORES_URL && !process.env.NEXT_PUBLIC_WHATSAPP_EXITO_URL && (
                <p className="text-sm text-slate-400 text-center py-2">Canales no configurados aún.</p>
              )}
            </div>
          </DashboardPanel>
        </div>
